package com.floweytech.agrotrack.iam.shared.infrastructure.documentation.openapi.configuration;
...
public class OpenApiConfiguration {
    ...
    public OpenAPI agrotrackPlatformOpenAPI() {
        ...
        openApi.addSecurityItem(new SecurityRequirement()
                ...
                .servers(List.of(
                        new Server().url("http://agrotrack-api-gateway-auaadra7bfhjasfa.southeastasia-01.azurewebsites.net").description("Azure API Gateway"),
